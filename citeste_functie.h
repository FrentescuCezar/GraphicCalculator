...
void Citeste_Functie(char s[MAX],int x, int y, int lungime, int latime, bool &errorf, short &ErrorType)
{
            ...
            //s - Primul rand de pe ecran , s2 - al doilea rand, s3 - al treilea rand , s_aux - sirul concatenat din toate cele 3 siruri
            strcpy(s,"");
    ...
    do
    {
        ...
        //Afisarea erorilor de scriere a functiilor in timp real
        ...
        //Niste limite de coordonate in care scrisul sa se incadreze in ecranul laboratorului
    ...
    }while (tasta!=13&&tasta!=27); // Daca tasta este Enter sau ESC , atunci se va termina scrierea functiei
    ...
    //Mai facem o verificare finala a functiei
